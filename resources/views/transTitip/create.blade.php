<!-- resources/views/transTitip/create.blade.php -->

@extends('layouts.app')

@section('content')
    <div class="container">
        <h2>Tambah Penitipan</h2>
        <form method="POST" action="{{ route('transTitip.store') }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="tgl_titip" name="tgl_titip" required>
            </div>
            <div class="form-group">
